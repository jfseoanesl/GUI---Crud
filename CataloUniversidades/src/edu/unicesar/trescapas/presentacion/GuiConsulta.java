...
public class GuiConsulta extends JDialog {
    ...
    public void filtrar(){
        String name = this.tBusqueda.getText().toUpperCase();
        List<Universidad> lista = this.modeloGU.filtrar(name);
        this.actualizarTabla(lista);
    }
    /*
    class filtroKeyPress extends KeyAdapter{// escuchador eventos teclado
